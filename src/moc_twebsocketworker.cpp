...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TWebSocketWorker_t, stringdata) + ofs \
...
const QMetaObject TWebSocketWorker::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_TWebSocketWorker.data,
      qt_meta_data_TWebSocketWorker,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TWebSocketWorker.stringdata))
