...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TEpollWebSocket_t, stringdata) + ofs \
...
const QMetaObject TEpollWebSocket::staticMetaObject = {
    { &TEpollSocket::staticMetaObject, qt_meta_stringdata_TEpollWebSocket.data,
      qt_meta_data_TEpollWebSocket,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TEpollWebSocket.stringdata))
