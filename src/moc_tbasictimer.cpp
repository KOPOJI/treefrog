...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TBasicTimer_t, stringdata) + ofs \
...
const QMetaObject TBasicTimer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TBasicTimer.data,
      qt_meta_data_TBasicTimer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TBasicTimer.stringdata))
