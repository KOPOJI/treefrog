...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TActionThread_t, stringdata) + ofs \
...
const QMetaObject TActionThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_TActionThread.data,
      qt_meta_data_TActionThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TActionThread.stringdata))
