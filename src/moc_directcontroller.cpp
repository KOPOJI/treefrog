...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DirectController_t, stringdata) + ofs \
...
const QMetaObject DirectController::staticMetaObject = {
    { &TActionController::staticMetaObject, qt_meta_stringdata_DirectController.data,
      qt_meta_data_DirectController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DirectController.stringdata))
