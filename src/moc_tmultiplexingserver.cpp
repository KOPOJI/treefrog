...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TMultiplexingServer_t, stringdata) + ofs \
...
const QMetaObject TMultiplexingServer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_TMultiplexingServer.data,
      qt_meta_data_TMultiplexingServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TMultiplexingServer.stringdata))
