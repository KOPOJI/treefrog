...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TSystemBus_t, stringdata) + ofs \
...
const QMetaObject TSystemBus::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TSystemBus.data,
      qt_meta_data_TSystemBus,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TSystemBus.stringdata))
