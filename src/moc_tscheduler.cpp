...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TScheduler_t, stringdata) + ofs \
...
const QMetaObject TScheduler::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_TScheduler.data,
      qt_meta_data_TScheduler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TScheduler.stringdata))
