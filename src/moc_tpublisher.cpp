...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TPublisher_t, stringdata) + ofs \
...
const QMetaObject TPublisher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TPublisher.data,
      qt_meta_data_TPublisher,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TPublisher.stringdata))
