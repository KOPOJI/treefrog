...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TreeFrog__ServerManager_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 107, 20),
QT_MOC_LITERAL(9, 128, 10),
...
const QMetaObject TreeFrog::ServerManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TreeFrog__ServerManager.data,
      qt_meta_data_TreeFrog__ServerManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TreeFrog__ServerManager.stringdata))
